...
export default function VideoUpdateForm(props) {
  ...
  const [vid, setVid] = React.useState(initialValues.vid);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Video, idProp)
        : videoModelProp;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Video.copyOf(videoRecord, (updated) => {
    ...
    >
      <TextField
        ...
        onChange={(e) => {
          ...
          if (errors.vid?.hasError) {
            runValidationTasks("vid", value);
          }
          setVid(value);
        }}
        onBlur={() => runValidationTasks("vid", vid)}
        errorMessage={errors.vid?.errorMessage}
        hasError={errors.vid?.hasError}
        {...getOverrideProps(overrides, "vid")}
      ></TextField>
      <ArrayField
